  ...
  return (
    <div className="about-company">
      ...
      <div className="about-section">
        <h3>מכירים סקיצות? </h3>
        <p>
          אז גם כאן סרטטנו סקיצה.
          <br />
          סקיצה לפתרון פשוט ונח לנושא ה-AI.
        </p>
      </div>
      <div className="about-section">
      ...
      <div className="about-section">
        <h3>💡 החזון שלנו</h3>
        <p>
          ליצור מערכת אקולוגית של כלי קוד פתוח המאפשרים לכל ארגון, מוסד חינוכי
      ...
      <div className="about-section">
        ...
        <p>
          ...
          SDK-ים ללשונות תכנות שונות, ועד תוספים לסביבות פיתוח. כל הפרויקטים
          זמינים ב-GitHub ומתועדים היטב כדי לאפשר לכל מפתח להצטרף ולתרום.
        </p>
      </div>
